...
data_path = "/home/datasets/VizWiz/test/"
img_list = os.listdir(data_path)
tsv_file = "./data/VizWiz/test/test.tsv"
label_file = "./data/VizWiz/test/test.label.tsv"
hw_file = "./data/VizWiz/test/test.hw.tsv"
linelist_file = "./data/VizWiz/test/test.linelist.tsv"
rows = []
rows_label = []
rows_hw = []
