...
# ==== Predefined splits for vizwiz images ===========
_PREDEFINED_SPLITS_VG = {
    "vizwiz_train": ("vizwiz/images", 
                            "vizwiz/annotations/vizwiz_train.json"),
    "vizwiz_val": ("vizwiz/images", 
                          "vizwiz/annotations/vizwiz_val.json"),
    "vizwiz_train_val": ("vizwiz/images", 
                           "vizwiz/annotations/vizwiz_train_val.json"),
    "vizwiz_test": ("vizwiz/images", 
                           "vizwiz/annotations/vizwiz_test.json"),
}
