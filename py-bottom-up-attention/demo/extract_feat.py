...
DATA_ROOT = os.path.join('/home/datasets/', 'VizWiz')
MIN_BOXES = 36
MAX_BOXES = 36

parser = argparse.ArgumentParser()
parser.add_argument('--split', default='test', help='train2014, val2014')
...
def build_model():
    ...
    if args.weight == 'mask':
        ...
        cfg.MODEL.WEIGHTS = "../checkpoints/faster_rcnn_from_caffe_attr.pkl"
    else:
...
if __name__ == "__main__":
    ...
    extract_feat('data/vizwiz_imgfeat/%s_obj36.tsv' % args.split, detector, pathXid)
